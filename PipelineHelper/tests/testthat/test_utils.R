...
test_that("constructFilename", {
    ...
    expect_equal(constructFilename(prefix="", suffix="b"), "b.RData")
    expect_equal(constructFilename(prefix="a", suffix="b"), "a_b.RData")
    expect_equal(constructFilename(prefix="a", suffix="b", sep=".", extension=".txt"), "a.b.txt")
})
