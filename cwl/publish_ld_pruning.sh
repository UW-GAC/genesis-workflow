...
sbpack bdc smgogarten/genesis-relatedness-pre-build/subset-gds tools/subset_gds.cwl
sbpack bdc smgogarten/genesis-relatedness-pre-build/merge-gds tools/merge_gds.cwl
sbpack bdc smgogarten/genesis-relatedness-pre-build/check-merged-gds tools/check_merged_gds.cwl
